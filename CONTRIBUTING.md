...
If you’re reading this, hopefully we have piqued your interest to take the next step. Join us and help make Sparsify even better! As a contributor, here are some community guidelines we would like you to follow:

 - [Code of Conduct](#code-of-conduct)
 - [Ways to Contribute](#ways-to-contribute)
 - [Bugs and Feature Requests](#bugs-and-feature-requests)
 - [Question or Problem?](#question-or-problem)
 - [Developing Sparsify](#developing-sparsify)
...
Whether you’re a newbie, dabbler, or expert, we appreciate you jumping in.
 ...
 - Spread the word about Sparsify (and if you feel inclined, @mention Neural Magic as we love hearing about it);
 - Teach and empower others. This is the way!

 ## Bugs and Feature Requests
 - Check out [GitHub Issues](https://github.com/neuralmagic/sparsify/issues) for reporting bugs and feature requests
...
If you want to contribute a model, start with sharing a brief introduction at [GitHub Discussions under Ideas](https://github.com/neuralmagic/sparsify/discussions/categories/ideas). Fellow Neural Magic engineers can work with your further to take next steps.

 ## Question or Problem
 - Post a topic to [GitHub Discussions](https://github.com/neuralmagic/sparsify/discussions/) for all other questions including support or how to contribute
...
### Building and running Sparsify locally

Sparsify is OS-agnostic. Requires Python 3.6 or higher. 
```python
...
To build and run Sparsify locally, run the following commands:
```shell
$ <command 1>
$ <command 2>
$ <command n>
 ...
 * [Upgrade notes](https://github.com/neuralmagic/sparsify/blob/master/docs/installation/upgrading.rst)
...
To enable commitlint, simply run `npm install` from the root directory of the sparsify repo
