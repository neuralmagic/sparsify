...
We will share more in the coming weeks. In the meantime, sign up for our [Waitlist](https://docs.neuralmagic.com/main/source/getstarted.html#sparsification) for early access to the Sparsify Alpha. 
