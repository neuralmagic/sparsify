...
export const useExportEffects = (dispatch, projectId, optimId, frameworkTab, sampleType) => {
    ...
    useEffect(() => {
        ...
        if (framework && sampleType !== "" && !(codeSample) ) {
            dispatch(getCodeSampleThunk({
                projectId, framework, sampleType
            }))
        }
    }, [dispatch, projectId, availableFrameworks, availableCodeSamples, frameworkTab, sampleType]);
}