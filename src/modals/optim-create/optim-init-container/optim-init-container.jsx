...
function OptimInitContainer({ onCancel, onNext}) {
    ...
    return (
        <DialogContent>
            ...
            {optimizerSelectTab === 0 && <CustomOptimSelect/>}
            ...
            <Box paddingY={3} display="flex" justifyContent="flex-start" alignItems="center">
                ...
                <Box paddingRight={1}>
                    <Button onClick={() => onCancel()} className={`${classes.button} ${classes.cancelButton}`}>
                        Cancel
                    </Button>
                </Box>
                <Box>
                    <Button onClick={() => onNext()} color="secondary" variant="contained" className={classes.button}>
                        Next
                    </Button>
                </Box>
            </Box>   
