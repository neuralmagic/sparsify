...
_REGISTERED_TASKS = {}
# exceptions to extract from torch distributed child process exceptions. Needs to be
# kept explicit to avoid arbitrary code execution
_CHILD_EXCEPTIONS_TO_CATCH = {"RuntimeError": RuntimeError}
