...
const PruningSettings = ({ showRecovery = true, className, modifier }) => {
  ...
  return (
    <div className={`${classes.root} ${className}`} key={modifier.modifier_id}>
          ...
          >
            ...
            <Grid item>
              <Slider
                ...
                onChange={(e, value) =>
                  changeAdjustableSettings({ balance_perf_loss: Number(value) })
                }
                onChangeCommitted={(e, value) =>
                  changeAdjustableSettings({ balance_perf_loss: Number(value) }, true)
                }
              />
            </Grid>
          </Grid>
