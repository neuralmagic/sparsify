...
function BenchmarkCreateDialog({ open, handleClose, projectId }) {
  ...
  const [inferenceEngine, setInferenceEngine] = useState(
    engines.includes("deepsparse") ? "deepsparse" : "ort_cpu"
  );
  ...
  useEffect(() => {
    if (systemInfoState.status === STATUS_SUCCEEDED) {
      ...
      setInferenceEngine(engines.includes("deepsparse") ? "deepsparse" : "ort_cpu");
    }
  }, [systemInfoState]);
              ...
              <Grid item xs={7}>
                <FormControl variant="outlined" fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value="deepsparse">Deepsparse</MenuItem>
