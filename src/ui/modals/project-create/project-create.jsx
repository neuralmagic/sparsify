...
function ProjectCreateDialog({ open, handleClose }) {
  ...
  const instructionSets =
    systemInfoState.val && systemInfoState.val.available_instructions
      ...
      : "";
  const deepsparseEngineAvailable =
    systemInfoState.val && systemInfoState.val.available_engines
      ? systemInfoState.val.available_engines.indexOf("deepsparse") > -1
      : false;
  let currentAction = {
    label: "next",
    id: "next",
  ...
  if (createProjectState.slideIndex === 0) {
    ...
    const profilesError = !deepsparseEngineAvailable && createProjectState.profilePerf;
    currentAction = {
        ...
        <DialogContent className={classes.content}>
          ...
          >
            ...
            <ProfileProject
              ...
              deepsparseEngineAvailable={deepsparseEngineAvailable}
              profiling={
